...
public:
    ...
    void setupUi(QMainWindow *MainWindowClass)
    {
        ...
        actionFixXML = new QAction(MainWindowClass);
        actionFixXML->setObjectName(QStringLiteral("actionFixXML"));
    ...
    {
        MainWindowClass->setWindowTitle(QApplication::translate("MainWindowClass", "CMP Data Viewer", 0));
